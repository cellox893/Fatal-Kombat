...
python3 scripts/run_godot.py --headless --path game --script tests/test_boxes.gd
python3 scripts/run_godot.py --headless --path game --script tests/test_commands.gd
